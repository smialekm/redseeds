package eu.redseeds.engine.perspective;
...
public class PerspectiveFactory implements IPerspectiveFactory {
	...
	public static String ID_PROJECT_EXPLORER 
		= "eu.redseeds.engine.navigator.view";//"org.eclipse.ui.navigator.ProjectExplorer";
    ...
    public void defineActions(IPageLayout layout) {
        ...
        layout.addPerspectiveShortcut("eu.redseeds.engine.perspective");
