...
import rsldl.diagram.edit.policies.DLAlghoritmicTransitionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DLAlghoritmicTransitionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DLAlghoritmicTransitionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DLAlghoritmicTransitionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DLAlghoritmicTransitionNameEditPart) {
			((DLAlghoritmicTransitionNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getDLRelationshipNameFigure());
			return true;
		}
		if (childEditPart instanceof DLAlghoritmicTransitionTypeEditPart) {
			((DLAlghoritmicTransitionTypeEditPart) childEditPart)
