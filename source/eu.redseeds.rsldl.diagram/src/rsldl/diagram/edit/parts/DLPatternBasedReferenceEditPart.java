...
import rsldl.diagram.edit.policies.DLPatternBasedReferenceItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DLPatternBasedReferenceEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DLPatternBasedReferenceEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DLPatternBasedReferenceItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DLPatternBasedReferenceNameEditPart) {
			((DLPatternBasedReferenceNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getDLRelationshipNameFigure());
			return true;
		}
		if (childEditPart instanceof DLPatternBasedReferenceTypeEditPart) {
			((DLPatternBasedReferenceTypeEditPart) childEditPart)
