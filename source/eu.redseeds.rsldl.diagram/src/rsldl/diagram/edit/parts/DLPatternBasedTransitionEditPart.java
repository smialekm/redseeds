...
import rsldl.diagram.edit.policies.DLPatternBasedTransitionItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DLPatternBasedTransitionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DLPatternBasedTransitionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DLPatternBasedTransitionItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DLPatternBasedTransitionNameEditPart) {
			((DLPatternBasedTransitionNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getDLRelationshipNameFigure());
			return true;
		}
		if (childEditPart instanceof DLPatternBasedTransitionTypeEditPart) {
			((DLPatternBasedTransitionTypeEditPart) childEditPart)
