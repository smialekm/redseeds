 ...
 * @generated
 */
public class RsldlDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public RsldlDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof RsldlDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((RsldlDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new RsldlDomainNavigatorItem((EObject) objects[i],
