...
import rsldl.diagram.part.RsldlDiagramEditor;
 ...
 * @generated
 */
public class RsldlNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof RsldlNavigatorItem) {
					selectedElement = ((RsldlNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, RsldlDiagramEditor.ID);
