...
public class AddNotionsPackageAction implements  IWorkbenchWindowActionDelegate, IViewActionDelegate{
	...
	public void run(IAction action) {
		...
		SCLElementWizard wizard = new SCLElementWizard(NotionsPackageDTO.class);
