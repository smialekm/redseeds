...
public class AddScenarioAction implements IWorkbenchWindowActionDelegate,
IViewActionDelegate{
...
private IViewPart navigator;
	...
	public void run(IAction action) {
		...
		SCLElementWizard wizard = new SCLElementWizard(ConstrainedLanguageScenarioDTO.class);
