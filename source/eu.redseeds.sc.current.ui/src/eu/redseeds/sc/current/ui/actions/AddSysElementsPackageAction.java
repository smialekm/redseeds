...
public class AddSysElementsPackageAction implements IWorkbenchWindowActionDelegate,
IViewActionDelegate {
	...
	public void run(IAction action) {				
		...
		SCLElementWizard wizard = new SCLElementWizard(SystemElementsPackageDTO.class);
