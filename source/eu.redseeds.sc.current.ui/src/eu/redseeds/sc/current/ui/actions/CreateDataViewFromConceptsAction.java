...
import eu.redseeds.sc.current.ui.wizards.CreateDataViewFromConceptsWizard;
import eu.redseeds.scl.model.rsl.rsldomainelements.notions.NotionDTO;

public class CreateDataViewFromConceptsAction implements IWorkbenchWindowActionDelegate,
IViewActionDelegate {
	...
	public void run(IAction action) {
		...
		CreateDataViewFromConceptsWizard wiz = new CreateDataViewFromConceptsWizard();
