...
public class NotionAttributeParentsComparator extends ViewerComparator {
	
	private int propertyIndex;
	private static final int DESCENDING = 1;
	private int direction;
	private TableViewer notAttPrtsTableViewer;
	
	public NotionAttributeParentsComparator() {
	...
	public void setViewer(TableViewer notAttsTableViewer) {
		this.notAttPrtsTableViewer = notAttsTableViewer;
	}
