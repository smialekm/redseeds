...
public class GetAnalysisFromEA_SelectionListener extends SelectionAdapter {
	...
	public void widgetSelected(SelectionEvent event) {
		...
		// execute Transformations and convertEAtoTG
		...
		workbench.getDisplay().syncExec(new Runnable() { 
			public void run() { 
				...
				if (window != null) { 
					...
					RunTransformationsJob action = new RunTransformationsJob("Getting Analysis model from the Enterprise Architect",
							                                                  exTransfList,
							                                                  currSCProject,
							                                                  "Analysis",
							                                                  3);
