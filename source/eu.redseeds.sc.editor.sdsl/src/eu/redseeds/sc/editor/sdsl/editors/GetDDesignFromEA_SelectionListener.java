...
public class GetDDesignFromEA_SelectionListener extends SelectionAdapter {
		...
		workbench.getDisplay().syncExec(new Runnable() { 
			public void run() { 
				...
				if (window != null) { 
					...
					RunTransformationsJob action = new RunTransformationsJob("Getting Detailed Design model from the Enterprise Architect",
							                                                  exTransfList,
							                                                  currSCProject,
							                                                  "Detailed Design",
							                                                  3);
					try {
			            ...
			            Activator.log("Error during getting Detailed Design", Status.ERROR);
			        }
				}
			}
		});
