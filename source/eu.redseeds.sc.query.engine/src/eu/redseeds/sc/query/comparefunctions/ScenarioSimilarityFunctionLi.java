 ...
 * 
 */
public class ScenarioSimilarityFunctionLi extends AbstractSimilarRemoteNodesLi {
	...
	public ScenarioSimilarityFunctionLi() {
		STRUCTURAL_SIMILARITY_INFLUENCE = 0.2f;
		SEMANTIC_SIMILARITY_INFLUENCE = 0.8f;
		SIMILARITY_TREATED_AS_EQUAL = 0.60f;
	}
	...
	private double compareScenarios(UkoCompareEngine engine, ConstrainedLanguageScenario scenario1,
		...
		double scenarioStepsSim = performComparison(engine, scenarioSteps1, scenarioSteps2);
		...
		if ((postcondition1 != null) && (postcondition2 != null)) {
			...
			if ((postcondition1 == null) && (postcondition2 == null)) {
				...
				// only one is null
				postconditionSimilarity = 0.5f;
			}
		}
		double similarity = (preconditionSimilarity	* realPreInf
				+ postconditionSimilarity * realPostInf
				+ (1-realPreInf-realPostInf) * scenarioStepsSim
               );
//		System.out.println("Similarity of Scenarios " + scenario1.getName() + " and " + scenario2.getName() + ": " + similarity);
//		System.out.println("  Pre: " + preconditionSimilarity + " Influence: " + realPreInf);
//		System.out.println("  Post: " + postconditionSimilarity + " Influence: " + realPostInf);
//		System.out.println("  Strucural: " + calculatedStrucutralSim  + " Influence: " + (STRUCTURAL_SIMILARITY_INFLUENCE * (1-realPostInf-realPreInf)));
//		System.out.println("  Semantic: " + calculatedSemanticSim  + " Influence: " + (SEMANTIC_SIMILARITY_INFLUENCE * (1-realPostInf-realPreInf)));	
		return similarity;
	}
