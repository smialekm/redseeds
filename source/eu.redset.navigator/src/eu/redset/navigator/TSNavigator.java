...
public class TSNavigator extends CommonNavigator {
	...
	public void createPartControl(Composite parent) {
		...
		this.getCommonViewer().setSorter(new TSProjectSorter());
	...
	protected CommonViewer createCommonViewer(Composite aParent) {
		TSCommonViewer aViewer = new TSCommonViewer(getViewSite().getId(), aParent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
