...
public class TCScenarioBasicInfoPanel extends Composite{
	...
	private TCRelatedTestsPanel scenRelatedTests;
	
	public TCScenarioBasicInfoPanel(Composite parent, int style) {
		super(parent, style);
	...
	public void createContent(){
		...
		nameInput.setText(this.testCase.getName());
		fd = new FormData();
		fd.top = new FormAttachment(0, 10);
		...
		trail.setText(TSLModelHelper.instance().getFullPath(this.testCase.eContainer(), false));
		fd = new FormData();
		fd.top = new FormAttachment(nameInput, 10);
		fd.left = new FormAttachment(nameLabel, 10);
		fd.right = new FormAttachment(50, 0);
		...
		ucNameInput.setText(this.testCase.getUcName());
		fd = new FormData();
		fd.top = new FormAttachment(0, 10);
		...
		ucTrail.setText(this.testCase.getUcTrail());
		fd = new FormData();
		fd.top = new FormAttachment(ucNameInput, 10);
		fd.left = new FormAttachment(ucNameLabel, 10);
		fd.right = new FormAttachment(100, -5);
		...
		scenRelatedTests = new TCRelatedTestsPanel(this, testCase, SWT.NONE);
		fd = new FormData();
