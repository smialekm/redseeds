...
public class UseCaseTestEditorContributor extends
MultiPageEditorActionBarContributor {
	...
	public UseCaseTestEditorContributor() {
		super();
		createActions();
	...
	@Override
	 public void setActiveEditor(IEditorPart part) {
	        this.editor = (UseCaseTestEditor)part;
	    }
	...
	public void contributeToMenu(IMenuManager manager) {
		...
		menu = new MenuManager("&UseCaseTest");
