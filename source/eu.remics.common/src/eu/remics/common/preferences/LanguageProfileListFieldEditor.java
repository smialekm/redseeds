...
public class LanguageProfileListFieldEditor extends FieldEditor {
	...
	public LanguageProfileListFieldEditor(String name, String labelText, Composite parent) {
		super(name, labelText, parent);		
	}
	
	public LanguageProfileListFieldEditor(String name, String labelText, String addButtonText, String removeButtonText, Composite parent) {
		super(name, labelText, parent);
	...
	protected void doFillIntoGrid(Composite parent, int numColumns) {
		...
		String[] titles = {"Language", "Map Keyword", "Name Converter Class"};
		...
		textField3 = new Text(fieldGroup, SWT.BORDER);
		
		GridData textData3 = new GridData(GridData.CENTER/*FILL_HORIZONTAL*/);
		textData3.horizontalSpan = numColumns - 1;
	...
	protected void setTable(String items) {
		...
		for (int i=0;i<st.length-2;i+=3){
			...
			item.setText (0,st[i]);
			item.setText(1,st[i+1]);
			item.setText(2,st[i+2]);
		}
	...
	protected void add() {
		if (textField.getText() != null && !textField.getText().isEmpty() && textField2.getText() != null && textField3.getText() != null && !textField3.getText().isEmpty()){
			TableItem item = new TableItem (table, 0);
			item.setText (0,textField.getText());
			item.setText(1,textField2.getText());
			item.setText(2,textField3.getText());
		}
		for (int i=0; i<table.getColumnCount(); i++) {
			table.getColumn (i).pack ();
		}
