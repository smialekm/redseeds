 ...
 * @generated
 */
public class UseCaseDiagramNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof UseCaseDiagramNavigatorItem) {
					selectedElement = ((UseCaseDiagramNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (UseCaseDiagramEditPart.MODEL_ID
							.equals(UseCaseDiagramVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, UseCaseDiagramDiagramEditor.ID);
