 ...
 * @generated NOT
 */
public class CreateUseCaseAction extends DiagramAction {

	public CreateUseCaseAction(IWorkbenchPart part) {
		super(part);
	}

	public CreateUseCaseAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}

	public void init() {
		super.init();
		setId("addUseCaseAction");
		setText("Use Case");
		setToolTipText("Create Use Case");
		setHoverImageDescriptor(UseCaseDiagramDiagramEditorPlugin
				.findImageDescriptor("/eu.remics.gmf/model/icons/usecase.gif"));
	...
	protected Request createTargetRequest() {
		IElementType type = UseCaseDiagramElementTypes.UseCase_2002;
