 ...
 * @generated
 */
public class UseCaseDiagramInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new UseCaseDiagramNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				UseCaseDiagramEditPart.MODEL_ID));
		UseCaseDiagramDiagramEditorUtil.runWizard(getShell(), wizard,
