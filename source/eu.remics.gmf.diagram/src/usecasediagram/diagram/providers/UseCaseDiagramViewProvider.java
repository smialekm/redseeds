 ...
 * @generated
 */
public class UseCaseDiagramViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = UseCaseDiagramVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = UseCaseDiagramVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!UseCaseDiagramElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != UseCaseDiagramVisualIDRegistry
				...
				if (!UseCaseDiagramEditPart.MODEL_ID
						.equals(UseCaseDiagramVisualIDRegistry.getModelID(op
								.getContainerView()))) {
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = UseCaseDiagramVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = UseCaseDiagramVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ActorEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (UseCaseDiagramVisualIDRegistry.getVisualID(elementTypeHint)) {
		case InvokeEditPart.VISUAL_ID:
			return createInvoke_4001(getSemanticElement(semanticAdapter),
	...
	public Node createActor_2001(EObject domainElement, View containerView,
		...
		node.setType(UseCaseDiagramVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createInvoke_4001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		edge.setType(UseCaseDiagramVisualIDRegistry
