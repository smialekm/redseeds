...
/**
 * This is the item provider adapter for a {@link usecasediagram.Association} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssociationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UsecasediagramPackage.Literals.ASSOCIATION__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UsecasediagramPackage.Literals.ASSOCIATION__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Association_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Association_id_feature", "_UI_Association_type"),
				 UsecasediagramPackage.Literals.ASSOCIATION__ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Association_type") + " " + association.getId();
	}
