...
/**
 * This is the item provider adapter for a {@link usecasediagram.Invoke} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InvokeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Invoke_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Invoke_target_feature", "_UI_Invoke_type"),
				 UsecasediagramPackage.Literals.INVOKE__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Invoke_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Invoke_source_feature", "_UI_Invoke_type"),
				 UsecasediagramPackage.Literals.INVOKE__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UsecasediagramPackage.Literals.INVOKE__ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Invoke_type") + " " + invoke.getId();
	}
