...
/**
 * This is the item provider adapter for a {@link usecasediagram.UseCase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 UsecasediagramPackage.Literals.USE_CASE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UseCase_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UseCase_id_feature", "_UI_UseCase_type"),
				 UsecasediagramPackage.Literals.USE_CASE__ID,
				 true,
				 false,
				 false,
