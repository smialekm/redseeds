 ...
 * @generated
 */
public class DirectedRelationCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DirectedRelationCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return NotionDiagramBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateDirectedRelation_4003(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		DirectedRelation newElement = NotiondiagramFactory.eINSTANCE
		...
		RecoveryModelHelper rmh = RecoveryModelHelper.instance(getContainer()
				.eResource());
		NotionDTO source = rmh.getNotionByVertexID(getSource().getId());
		NotionDTO target = rmh.getNotionByVertexID(getTarget().getId());
	 ...
	 * @generated
	 */
	protected void doConfigure(DirectedRelation newElement,
