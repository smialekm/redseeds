 ...
 * @generated
 */
public class NotionNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NotionNameEditPart(View view) {
		super(view);
	}
			...
			parser = NotionDiagramParserProvider
					.getParser(
							...
							NotionDiagramVisualIDRegistry
									.getType(notiondiagram.diagram.edit.parts.NotionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
