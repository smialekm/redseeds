...
import notiondiagram.diagram.edit.policies.NotionDiagramTextSelectionEditPolicy;
 ...
 * @generated
 */
public class PhraseTextEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PhraseTextEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new NotionDiagramTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new NotionDiagramEditPart.NodeLabelDragPolicy());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof NotionDiagramTextSelectionEditPolicy) {
			((NotionDiagramTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof NotionDiagramTextSelectionEditPolicy) {
			((NotionDiagramTextSelectionEditPolicy) sfEditPolicy)
					.refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = NotionDiagramParserProvider
					.getParser(
							NotionDiagramElementTypes.Phrase_3001,
							getParserElement(),
							NotionDiagramVisualIDRegistry
									.getType(notiondiagram.diagram.edit.parts.PhraseTextEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this,
					...
					NotionDiagramEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	public void performRequest(Request request) {
		if (RequestConstants.REQ_OPEN.equals(request.getType())) {
			if (request instanceof SelectionRequest) {
				EObject elem = ((DecorationNodeImpl) this.getModel())
						.getElement();
				if (elem instanceof Phrase) {
					Phrase phrase = (Phrase) elem;
					IWorkbenchPage activePage = PlatformUI.getWorkbench()
							.getActiveWorkbenchWindow().getActivePage();
					RecoveryModelHelper rmh = RecoveryModelHelper.instance(elem
							.eResource());
					DomainStatementDTO selectedElement = rmh
							.getDomainStatementByVertexID(phrase.getId());
					NotionEditorInput notionInput = new NotionEditorInput();
					NotionDTO notion = ((DomainStatementDTO) selectedElement)
							.getParent();
					...
					try {
						...
						openPropertyAction.setProject(SCProjectContainer
								.instance().getSCProject(selectedElement));
						openPropertyAction.setParent(notionEditor);
						openPropertyAction
								.setPhraseOrTerm(((DomainStatementDTO) selectedElement)
										.getPhraseDTO());
						...
						dialog.setScProject(SCProjectContainer.instance()
								.getSCProject(selectedElement));
