 ...
 * @generated
 */
public class NotionDiagramNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof NotionDiagramNavigatorItem) {
					selectedElement = ((NotionDiagramNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (NotionDiagramEditPart.MODEL_ID
							.equals(NotionDiagramVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, NotionDiagramDiagramEditor.ID);
