 ...
 * @generated NOT
 */
public class CreateAttributeNotionAction extends DiagramAction {

	public CreateAttributeNotionAction(IWorkbenchPart part) {
		super(part);
	}

	public CreateAttributeNotionAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}

	public void init() {
		super.init();
		setId("addAttributeNotionAction");
		setText("Notion (Attribute)");
		setToolTipText("Create Notion (Attribute)");
	...
	protected Request createTargetRequest() {
		IElementType type = NotionDiagramElementTypes.Notion_2006;
