 ...
 * @generated NOT
 */
public class CreateConceptNotionAction extends DiagramAction {

	public CreateConceptNotionAction(IWorkbenchPart part) {
		super(part);
	}

	public CreateConceptNotionAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}

	public void init() {
		super.init();
		setId("addConceptNotionAction");
		setText("Notion (Concept)");
		setToolTipText("Create Notion (Concept)");
