 ...
 * @generated NOT
 */
public class CreateConfirmationDialogNotionAction extends DiagramAction {

	public CreateConfirmationDialogNotionAction(IWorkbenchPart part) {
		super(part);
	}

	public CreateConfirmationDialogNotionAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}

	public void init() {
		super.init();
		setId("addConfirmationDialogNotionAction");
		setText("Notion (ConfirmationDialog)");
		setToolTipText("Create Notion (ConfirmationDialog)");
	...
	protected Request createTargetRequest() {
		IElementType type = NotionDiagramElementTypes.Notion_2004;
