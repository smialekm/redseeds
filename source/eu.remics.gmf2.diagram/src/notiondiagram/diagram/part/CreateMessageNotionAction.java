 ...
 * @generated NOT
 */
public class CreateMessageNotionAction extends DiagramAction {

	public CreateMessageNotionAction(IWorkbenchPart part) {
		super(part);
	}

	public CreateMessageNotionAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}

	public void init() {
		super.init();
		setId("addMessageNotionAction");
		setText("Notion (Message)");
		setToolTipText("Create Notion (Message)");
	...
	protected Request createTargetRequest() {
		IElementType type = NotionDiagramElementTypes.Notion_2003;
