 ...
 * @generated NOT
 */
public class CreateOptionNotionAction extends DiagramAction {

	public CreateOptionNotionAction(IWorkbenchPart part) {
		super(part);
	}

	public CreateOptionNotionAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}

	public void init() {
		super.init();
		setId("addOptionNotionAction");
		setText("Notion (Option)");
		setToolTipText("Create Notion (Option)");
	...
	protected Request createTargetRequest() {
		IElementType type = NotionDiagramElementTypes.Notion_2007;
