 ...
 * @generated NOT
 */
public class CreateScreenNotionAction extends DiagramAction {

	public CreateScreenNotionAction(IWorkbenchPart part) {
		super(part);
	}

	public CreateScreenNotionAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}

	public void init() {
		super.init();
		setId("addScreenNotionAction");
		setText("Notion (Screen)");
		setToolTipText("Create Notion (Screen)");
	...
	protected Request createTargetRequest() {
		IElementType type = NotionDiagramElementTypes.Notion_2002;
