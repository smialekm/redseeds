 ...
 * @generated NOT
 */
public class CreateSimpleViewNotionAction extends DiagramAction {

	public CreateSimpleViewNotionAction(IWorkbenchPart part) {
		super(part);
	}

	public CreateSimpleViewNotionAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}

	public void init() {
		super.init();
		setId("addSimpleViewNotionAction");
		setText("Notion (SimpleView)");
		setToolTipText("Create Notion (SimpleView)");
	...
	protected Request createTargetRequest() {
		IElementType type = NotionDiagramElementTypes.Notion_2009;
