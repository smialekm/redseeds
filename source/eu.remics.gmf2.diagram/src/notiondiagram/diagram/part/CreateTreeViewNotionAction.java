 ...
 * @generated NOT
 */
public class CreateTreeViewNotionAction extends DiagramAction {

	public CreateTreeViewNotionAction(IWorkbenchPart part) {
		super(part);
	}

	public CreateTreeViewNotionAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}

	public void init() {
		super.init();
		setId("addTreeViewNotionAction");
		setText("Notion (TreeView)");
		setToolTipText("Create Notion (TreeView)");
	...
	protected Request createTargetRequest() {
		IElementType type = NotionDiagramElementTypes.Notion_2010;
