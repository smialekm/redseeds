 ...
 * @generated NOT
 */
public class CreateTriggerNotionAction extends DiagramAction {

	public CreateTriggerNotionAction(IWorkbenchPart part) {
		super(part);
	}

	public CreateTriggerNotionAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}

	public void init() {
		super.init();
		setId("addTriggerNotionAction");
		setText("Notion (Trigger)");
		setToolTipText("Create Notion (Trigger)");
	...
	protected Request createTargetRequest() {
		IElementType type = NotionDiagramElementTypes.Notion_2005;
