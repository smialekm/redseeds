 ...
 * @generated
 */
public class NotionDiagramInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new NotionDiagramNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				NotionDiagramEditPart.MODEL_ID));
		NotionDiagramDiagramEditorUtil.runWizard(getShell(), wizard,
