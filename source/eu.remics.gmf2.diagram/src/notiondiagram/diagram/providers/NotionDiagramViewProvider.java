 ...
 * @generated
 */
public class NotionDiagramViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return NotionDiagramEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = NotionDiagramVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = NotionDiagramVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!NotionDiagramElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != NotionDiagramVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!NotionDiagramEditPart.MODEL_ID
						.equals(NotionDiagramVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return NotionEditPart.VISUAL_ID == visualID
				|| PhraseEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = NotionDiagramVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(NotionDiagramEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = NotionDiagramVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case NotionEditPart.VISUAL_ID:
			return createNotion_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case PhraseEditPart.VISUAL_ID:
			return createPhrase_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (NotionDiagramVisualIDRegistry.getVisualID(elementTypeHint)) {
		case GeneralizationEditPart.VISUAL_ID:
			return createGeneralization_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case AttributeRelationEditPart.VISUAL_ID:
			return createAttributeRelation_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case DirectedRelationEditPart.VISUAL_ID:
			return createDirectedRelation_4003(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case IndirectRelationEditPart.VISUAL_ID:
			return createIndirectRelation_4004(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createNotion_2001(EObject domainElement, View containerView,
		...
		node.setType(NotionDiagramVisualIDRegistry
				.getType(NotionEditPart.VISUAL_ID));
		...
		Node label5003 = createLabel(node,
				NotionDiagramVisualIDRegistry
						.getType(NotionTypeEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Node createPhrase_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(NotionDiagramVisualIDRegistry
				.getType(PhraseEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Edge createGeneralization_4001(EObject domainElement,
		...
		edge.setType(NotionDiagramVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createAttributeRelation_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(NotionDiagramVisualIDRegistry
				.getType(AttributeRelationEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
	 ...
	 * @generated
	 */
	public Edge createDirectedRelation_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(NotionDiagramVisualIDRegistry
				.getType(DirectedRelationEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
		...
		location6001.setX(0);
		location6001.setY(30);
		Node label6002 = createLabel(
				edge,
				NotionDiagramVisualIDRegistry
						.getType(DirectedRelationTargetMultiplicityEditPart.VISUAL_ID));
		label6002.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location6002 = (Location) label6002.getLayoutConstraint();
		location6002.setX(0);
		location6002.setY(30);
		Node label6005 = createLabel(edge,
				NotionDiagramVisualIDRegistry
						.getType(DirectedRelationStereotypeEditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createIndirectRelation_4004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		...
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(NotionDiagramVisualIDRegistry
				.getType(IndirectRelationEditPart.VISUAL_ID));
		edge.setElement(domainElement);
		// initializePreferences
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
				.getPreferenceStore();
		...
		location6003.setX(0);
		location6003.setY(30);
		Node label6004 = createLabel(
				edge,
				NotionDiagramVisualIDRegistry
						.getType(IndirectRelationTargetMultiplicityEditPart.VISUAL_ID));
		label6004.setLayoutConstraint(NotationFactory.eINSTANCE
				.createLocation());
		Location location6004 = (Location) label6004.getLayoutConstraint();
		location6004.setX(0);
		location6004.setY(30);
		Node label6006 = createLabel(edge,
				NotionDiagramVisualIDRegistry
						.getType(IndirectRelationStereotypeEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!NotionDiagramEditPart.MODEL_ID
				.equals(NotionDiagramVisualIDRegistry.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE
					.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
					"modelID", NotionDiagramEditPart.MODEL_ID); //$NON-NLS-1$
